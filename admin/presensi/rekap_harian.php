    ...
    <div class="container-xl">
        ...
        <table class="table table-bordered">
            ...
            while($rekap = mysqli_fetch_array($result)) : 
                ...
                $terlamabat = $timestamp_jam_masuk_real - $timestamp_jam_masuk_kantor;
                $total_jam_terlambat = floor($terlamabat / 3600);
                $terlamabat -= $total_jam_terlambat * 3600;
                $selisih_menit_terlambat = floor($terlamabat / 60);
