    ...
    <div class="container-xl">
        ...
        <table class="table table-bordered mt-3">
            ...
            <?php if(mysqli_num_rows($result) === 0) { ?>
                <tr>
                    <td colspan="6">Data masih kosong, silahkan tambahkan data baru</td>
                </tr>
            <?php } else { ?>
                <?php $no = 1;
                while($lokasi = mysqli_fetch_array($result)) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= base_url('admin/data_lokasi_presensi/hapus.php?id=' . $lokasi['id']) ?>" class="badge badge-pill bg-danger btn-delete">Hapus</a>
                        </td>
                    </tr>
                <?php endwhile; ?>    
            <?php } ?>
