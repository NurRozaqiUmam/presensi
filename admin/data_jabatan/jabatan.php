...
<div class="page-body">
    <div class="container-xl">
        <a href="<?= base_url('admin/data_jabatan/tambah.php') ?>" class="btn btn-primary"><span class="text">
                ...
                while($jabatan = mysqli_fetch_array($result)) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= base_url('admin/data_jabatan/hapus.php?id=' . $jabatan['id']) ?>" class="badge bg-danger badge-pill btn-delete">Hapus</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
                <?php endif; ?>
