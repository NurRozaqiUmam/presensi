...
if (isset($_POST['login'])) {
    ...
    $result = $connection->query("SELECT * FROM users JOIN pegawai ON users.id_pegawai = pegawai.id WHERE username = '$username'");
      ...
      <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
          ...
          <div class="col-lg d-none d-lg-block">
            <img src="<?= base_url('assets/img/secure_login.svg') ?>" height="300" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
